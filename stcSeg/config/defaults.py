...
# The options for STC-Seg
_C.MODEL.STCSEG = CN()
# Whether to enable BoxInst
_C.MODEL.STCSEG.ENABLED = False
_C.MODEL.STCSEG.BOTTOM_PIXELS_REMOVED = 10

_C.MODEL.STCSEG.BCE_LOSS = CN()
_C.MODEL.STCSEG.BCE_LOSS.ENABLED = False

_C.MODEL.STCSEG.BOUNDARY = CN()
_C.MODEL.STCSEG.BOUNDARY.SIZE = 3
_C.MODEL.STCSEG.BOUNDARY.DILATION = 2
_C.MODEL.STCSEG.BOUNDARY.WARMUP_ITERS = 10000
_C.MODEL.STCSEG.BOUNDARY.COLOR_THRESH = 0.3

_C.MODEL.STCSEG.BOUNDARY.USE_DEPTH = False
_C.MODEL.STCSEG.BOUNDARY.DEPTH_COLOR_THRESH = 0.1

_C.MODEL.STCSEG.BOUNDARY.USE_OPTICAL_FLOW = False
_C.MODEL.STCSEG.BOUNDARY.FLOW_COLOR_THRESH = 0.1

_C.MODEL.STCSEG.BOUNDARY.SIMILARITY_METHOD = "PLUS"
_C.MODEL.STCSEG.BOUNDARY.FINAL_THRESH = 0.003
