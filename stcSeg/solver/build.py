...
def build_optimizer(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    ...
    # optimizer = torch.optim.SGD([
    #     {'params': model.proposal_generator.parameters(), 'lr': cfg.SOLVER.BASE_LR},
    #     {'params': model.mask_head.parameters(), 'lr': cfg.SOLVER.BASE_LR * 0.1},
    #     {'params': model.mask_branch.parameters(), 'lr': cfg.SOLVER.BASE_LR * 0.1},
    #     {'params': model.controller.parameters(), 'lr': cfg.SOLVER.BASE_LR * 0.1},
    #     ], cfg.SOLVER.BASE_LR, momentum=cfg.SOLVER.MOMENTUM, nesterov=cfg.SOLVER.NESTEROV
    # )
